...
TERRAFORM_DIR = "terraform/researcher"
...
def get_service_url():
    ...
    try:
        ...
        print("   Make sure terraform/researcher has been applied after deploying the image.")
        sys.exit(1)
...
def main():
    parser = argparse.ArgumentParser(
        description="Test the Wealthix Researcher service",
